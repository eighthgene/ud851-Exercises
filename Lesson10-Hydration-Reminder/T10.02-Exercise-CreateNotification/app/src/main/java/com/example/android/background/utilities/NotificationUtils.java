...
public class NotificationUtils {
    private final static int WATER_REMINDER_PENDING_INTENT_ID = 801;
    private final static String WATER_REMINDER_NOTIFICATION_CHANEL_ID = "reminder_notification_channel";
    private final static int WATER_REMINDER_NOTIFICATIN_ID = 800;
    ...
    public static void remindUserBecauseCharging(Context context) {
        ...
        if (Build.VERSION.SDK_INT > Build.VERSION_CODES.O) {
            NotificationChannel mChanel = new NotificationChannel(
        ...
        notificationManager.notify(WATER_REMINDER_NOTIFICATIN_ID, notificationBuilder.build());
    }
