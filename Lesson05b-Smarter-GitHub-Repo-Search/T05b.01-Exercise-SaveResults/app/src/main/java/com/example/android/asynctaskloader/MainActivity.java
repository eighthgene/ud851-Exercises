...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null){
            ...
            String resultJason = savedInstanceState.getString(SEARCH_QUERY_RESULTS);

            mUrlDisplayTextView.setText(queryUrl);
            mSearchResultsTextView.setText(resultJason);
        }
    }
    ...
    // COMPLETED (7) Put the contents of the TextView that contains our raw JSON search results into a variable
        String resultJason = mSearchResultsTextView.getText().toString();
    // COMPLETED (8) Using the key for the raw JSON search results, put the search results into the outState Bundle
        outState.putString(SEARCH_QUERY_RESULTS, resultJason);
    }
}